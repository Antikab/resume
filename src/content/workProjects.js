...
export const workProjects = [
  {
    ...
    bullets: [
      ...
      'Разработал NestJS API с расчётами в PostGIS и Zod-валидацией; добавил тесты Vitest и Jest. Подключение слоёв организовано через типизированные конфигурации frontend и backend.'
    ],
    stack: [
      'Vue 3',
      'TypeScript',
  ...
  },
  {
    ...
    bullets: [
      'Разработал SPA на Vue 3, JavaScript и OpenLayers: выбор районов, рисование полигонов и окружностей, импорт и экспорт GeoJSON.',
  ...
  },
  {
    ...
    bullets: [
      ...
      'Реализовал транзакционный импорт батчами и перенос проверенных слоёв между БД через PostgreSQL COPY; несовместимые изменения схемы направляются во временную БД на ревью.',
