    ...
    descriptions: [
      {
        ...
        descriptionJob: `Исправлена проблема воспроизведения видео в Firefox.
          Реализовано автопроигрывание и автостоп видео во всех браузерах с учётом нюансов работы в Safari.
          Улучшена навигация и дизайн кнопок и текстов. Добавлено ограничение длины заголовков для повышения
          читаемости. Упрощена форма создания постов. Удалены избыточные элементы из поиска. Добавлена контактная
          информация и реализована логика статуса «Residence».`,
        resultTitle: 'Результат:',
        result: `Повысилось удобство пользовательского взаимодействия благодаря сокращению визуальных помех
          и улучшению навигации. Увеличилась удовлетворённость пользователей: число положительных отзывов выросло
